...
def getCost(seq, nextSeq = ""): #can be improved, instead of passing whole next seq, just need first beat
    if seq[1:] == ('0'*(len(seq)-1)):  # null
        ...
        cost = 2
    elif seq[0] == 1 and (nextSeq == "" or nextSeq[0] == 0):  # run2
        cost = 2
    elif seq[-1] == 1 and nextSeq != "" and nextSeq[0] == 1:  # upbeat
        cost = 3
